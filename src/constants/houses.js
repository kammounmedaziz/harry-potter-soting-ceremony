...
export const THINKING_MESSAGES = [
  `🎩 The Sorting Hat is placed upon your head...`,
  `🌟 Ancient magic swirls through the Great Hall...`,
  `🔮 The Hat peers deep into your mind and soul...`,
  `⚡ Searching for courage, wisdom, loyalty, and ambition...`,
  `🌙 The founders' voices whisper ancient secrets...`,
  `✨ Destiny itself hangs in the balance...`,
  `🎭 The Hat prepares to speak its judgment...`
];